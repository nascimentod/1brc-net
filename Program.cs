...
public class MeasurementCalculator 
{
    ...
    private static void ProcessLine(Dictionary<string, Measurement> dictionary, string? line)
    {
    ...
    private static void PrintToConsole(Dictionary<string, Measurement> dictionary)
    {
